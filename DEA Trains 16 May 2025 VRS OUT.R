...
print("Performing DEA with VRS (Input-Oriented)...")
vrs_oo_result <- dea(X, Y, RTS = "VRS", ORIENTATION = "out", SLACK = TRUE)

# --- Analyze and Access Results ---

vrs_efficiency_scores <- vrs_oo_result$eff

print("\nDEA Results:")
print("VRS Input-Oriented Efficiency Scores (first 10 DMUs):")
print(head(vrs_efficiency_scores, 266)) 

DEARaw$VRS_Efficiency_OO <- vrs_efficiency_scores
