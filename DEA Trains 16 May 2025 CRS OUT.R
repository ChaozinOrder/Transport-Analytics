...
crs_oo_result <- dea(X, Y, RTS = "CRS", ORIENTATION = "out", SLACK = TRUE)

# --- Analyze and Access Results ---

crs_efficiency_scores <- crs_oo_result$eff

print("\nDEA Results:")
print("CRS Input-Oriented Efficiency Scores (first 10 DMUs):")
print(head(crs_efficiency_scores, 266)) 

DEARaw$CRS_Efficiency_OO <- crs_efficiency_scores
