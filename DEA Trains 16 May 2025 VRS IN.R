...
vrs_io_result <- dea(X, Y, RTS = "VRS", ORIENTATION = "in", SLACK = TRUE)

# --- Analyze and Access Results ---

vrs_efficiency_scores <- vrs_io_result$eff

print("\nDEA Results:")
print("VRS Input-Oriented Efficiency Scores (first 10 DMUs):")
print(head(vrs_efficiency_scores, 266)) 

DEARaw$VRS_Efficiency_IO <- vrs_efficiency_scores
